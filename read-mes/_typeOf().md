...
*/
    ...
    function A_yourFunc(an_arg, the_answer){
       the_type = type_czech.typeOf(an_arg)
    ...
    if (expected_tests !== total_tests) 
        throw `A. _typeOf().md ${expected_tests} expected_tests !== ${total_tests} total_tests`
    else if (expected_fails !== fail_tests) 
        throw `A. _typeOf().md ${expected_fails} expected_fails !== ${fail_tests} fail_tests`
