'use strict';const VERS_NUM="v1.0 21-11-10";let the_exports;the_exports="undefined"===typeof exports?window:exports;if("undefined"===typeof TYPE_CZECH_current_test_number)var TYPE_CZECH_current_test_number="not-in-test-yet";
(function(O){O.TypeCzech=function(){function Ha(...fa){function P(a,b){a=A(a);a=a.substring(1,a.length-1);console.log(`%c ${a}`,b)}function qa(a){return a.replace(/"/g,"'")}function B(a){a=u(a);return"array"===a?!0:"object"===a}function p(a){if(B(a))a=Ia(a);else if("undefined"===typeof a)a="undefined";else if("bigint"===typeof a)a=`${a}n`;else if("string"===typeof a)'"Str_ify:null"'===a?a="null":'"Str_ify:und"'===a?a="undefined":'"Str_ify:NaN"'===a?a="NaN":'"Str_ify:Inf"'===a?a="Infinity":(a=a.replace(/"/g,
...
c=!1));return[a,b,c]}function y(a,b,c){c=p(c);return[a,b,c]}function Aa(a){function b(){return`${X} : ${ia}`}function c(k){const l=[];k.forEach(q=>{const n=L(q);n?l.push(`'${n}'`):(q=A(q),l.push(q))});return l}function d(k,l,q,n,v){X+=1;ja&&P([X],"background: #ee0; color: #00F");if(k){ia+=1;Sa(b());l="assert_check()"===v?` ${l}`:` ${l}() ${q} `;if("string"===typeof k)l=k;else{const [x,t,E]=k;k=c(n);1<k.length?(k=`[${k}]`,n=p(n)):(n=p(n),n=n.substring(1,n.length-1));l=l+t+("\n\t\t"+x);q=" EMPTY ASSERTION";
"check_type()"===x||"check_typeVariadic()"===x||"check_typeExtra()"===x||"check_typeEither()"===x?q="   EXPECTED TYPE":"check_mutatedSnapshot()"===x?q="":"assert_check()"===x&&(q="  EXPECTED");l+=`${"\n\t\t"}${"    ACTUAL TYPES"} ${k}`;l+=`${"\n\t\t"}${"    ACTUAL VALUE"} ${n}`;q&&(l+=`${"\n\t\t"}${q} ${E}`);l+=`${"\n\t\t"}${"CALLING FUNCTION"} ${v}`;l+="\n\t\t"}if(Y)throw Error(l);Z&&console.log(l)}}function e(k){k=k.toString().match(ob);const l=`${k[0]})`.replace(/^function /,"");k[2].split(", ").includes("arguments")&&
P(`Param 'arguments' shadows arguments object : ${k[0]})`,"background: #ee0; color: #00F");return l}function g(k,l,q){const n=e(q),v=q.apply(null,l);d(v,q.name,k,l,n)}function f(k,l,q,n){const v=e(n);l=n.apply(l,q);d(l,n.name,k,q,v)}function m(k){return"object"===typeof k?`{ ${Object.keys(k).map(l=>`${l}()`).reduce((l,q)=>`${l}, ${q}`)} }`:`${k.name}()`}function r(k,l,q){if("function"!==typeof k&&"object"!==typeof k)throw k=p(k),h(`${l}, is a not a function or an object that has a value of '${k}'`,
q);}function w(k,l){const q=m(l);if(void 0===k)throw h(`Function to be checked by ${q} is 'undefined', maybe namespace issue`,"EX@102");if(k===l)throw h(`_ParametersCheck you cannot use ${k.name}() to test`+`${l.name}(), they must be different`,"EX@103");}function C(k,l,q){const n=k.name;return new Proxy(k,{apply(v,x,t){aa(b());F&&l&&("undefined"===typeof x?g(`${n}${"() "}${"PRE-FUNC:"}`,t,l):f(`${n}${"() "}${"PRE-FUNC:"}`,x,t,l));v=v.apply(x,t);F&&q&&("undefined"===typeof x?g(`${n}${"() "}${"POST-FUNC:"}`,
[v],q):f(`${n}${"() "}${"POST-FUNC:"}`,x,[v],q));return v}})}function G(k,l,q,n){const v=new Set;q&&Object.keys(q).forEach(t=>v.add(t));n&&Object.keys(n).forEach(t=>v.add(t));let x=!1;Object.isFrozen(l)&&(x=!0,l=Object.assign({},l));v.forEach(t=>{if(t!==k){let E=!1;q&&(E=q[t]||!1);let M=!1;n&&(M=n[t]||!1);l[t]&&(l[t]=C(l[t],E,M))}});x&&Object.freeze(l);return l}function H(k,l){return"function"===typeof k?k:"undefined"===typeof k?!1:k[l]}function ka(k,l,q){const n=k.name,v=H(l,n),x=H(q,n);return new Proxy(k,
{apply(){},construct(t,E,M){aa(b());F&&v&&g(`${n}${"() "}${"PRE-CLASS:"}`,E,v);t=Reflect.construct(t,E,M);t=G(n,t,l,q);F&&x&&f(`${n}${"() "}${"POST-CLASS:"}`,t,[t],x);return t}})}function pb(k,l,q){const n=k.name,v=H(l,n),x=H(q,n);return new Proxy(k,{apply(t,E,M){aa(b());F&&v&&g(`${n}${"() "}${"PRE-OBJ:"}`,M,v);t=t.apply(E,M);t=G(n,t,l,q);F&&x&&g(`${n}${"() "}${"PRE-OBJ:"}`,[t],q[n]);return t},construct(t,E){aa(b());F&&v&&g(`${n}${"() "}${"POST-OBJ:"}`,E,v);t=new t(...E);t=G(n,t,l,q);F&&x&&f(`${n}${"() "}${"POST-OBJ:"}`,
...
"EX@115");Ka(k)?v=ka(k,l,q):(v=u(l),x=u(q),v="object"===v||"object"===x?pb(k,l,q):C(k,l,q));Ta.add(v);return v}var T=arguments.length;if(1<T)throw h(`_ParametersCheck() needs 0 or 1 params, not ${T}`,"ME@407");let aa=()=>"",Sa=()=>"",X=0,ia=0,F=!1;T=(k,l,q)=>k;T=U?qb:T;if(U){a&&"object"!==u(a)&&P(["_ParametersCheck - arg_check_events is not an Object with onStart(), onCheck(), onError() ",a],"background: #ee0; color: #F00");"undefined"!==typeof window&&P(["TypeCzech-init",VERS_NUM,Y?"THROW-EXCEPTIONS":
...
"TE@206"):(a=`The value '${p(a)}', which is a '${c}', is not a '${b}'`,c=h(a,"TE@226"))):Na(a)!==b&&("string"===u(b)?c=Ua(b):(a=`The type '${p(b)}' is invalid`,c=h(a,"TE@230")));return c}function V(a,b,c){return B(b)?ma(a,b,c):ab(a,b)}function bb(a,b){if(0===a.length)b=h("Array with no empty type elems, [], should have at least one, like ['EMPTY-ERROR']","EE@316");else{a=Object.entries(a);const [c,d]=a[0];b=A(b);b=h(`ELEMENT '${c}' is promised to be a '${d}', but is missing : ${b}`,"EE@310")}return b}
function cb(a,b,c,d,e,g){e=A(d);return"EMPTY-ERROR"===a||"ER"===a?S(b)?h(`ELEMENT '${c}' is erroneously empty :`,"EE@311"):"":"EMPTY-OK"===a||"OK"===a||"EMPTY-IGNORE"===a||"IG"===a?J(d[c],a,g):"string"===u(a)?h(`ELEMENT '${c}' is incorrect type, '${a}', only`+` [ER,EMPTY-ERROR,EMPTY-OK,OK,EMPTY-IGNORE,IG] allowed : ${e}`,"EE@312"):J(d[c],a,g)}function rb(a,b,c,d){b=A(b);return h(`Param array ${a} does not have the same number of elems as ${b}. `+` Different lengths ${c} !== ${d}`,"ME@404")}function J(a,
b,c){const d=u(b);return void 0===b?"":"array"===d?"array"===u(b[0])?1===b.length?na(a,b[0],c):na(a,b,c):"array"===u(a)?db(a,b,c):na(a,b,c):"object"===d?eb(a,b,c):Ba(a,b)}function Ba(a,b){let c="";b=Q(b);const d=u(a);if("EMPTY-ERROR"===b){const e=u(a);if(Ca(e))S(a)&&("object"===d&&(a="{ }"),a=p(a),c=h(`${b} states '${d}' must not `+`be empty for the value ${a}`,"EE@307"));else if("null"===d||"undefined"===d)c=h(`A '${d}' cannot be empty, so the state`+` of '${b}' is illegal for the value '${a}'`,
"EE@308")}else"EMPTY-OK"!==b&&"EMPTY-IGNORE"!==b&&(c=h(`Must 'EMPTY-OK' or 'EMPTY-ERROR' not '${b}'`,"EE@304"));return c}function fb(a,b,c){return B(b)?J(a,b,c):Ba(a,b)}function ca(a,b,c){return 1!==b.length||"EMPTY-OK"!==b[0]&&"OK"!==b[0]?fb(a,b,c):h("Pointless as ['EMPTY-OK'] matches all","EE@305")}function gb(a,b){const [c,d]=a;let e=a="",g=!1;d.forEach(f=>{let m=f;"string"===f&&1===c.length&&(m=[f]);f=ca(c,m,b);""===f?g=!0:e=f});g||(a=e);return a}function hb(a,b){const [c,d]=a,e=[];let g=!1;d.forEach(f=>
{let m=f;if("string"===f){let r=!1;Array.isArray(c)&&1===c.length&&(r=!0);r&&(m=[f])}f=V(c,m,b);""===f?g=!0:e.push(f)});if(g)a="";else{a=e.shift();const f=e.pop();a=0===e.length?`${a}, ${f}`:1===e.length?`${a}, ${f}, plus 1 more Either error`:`${a}, ${f}, plus ${e.length} more Either errors`}return a}function ib(a){let b=a;a=a[0];Array.isArray(a)&&(b=a);b.forEach(c=>{if("object"===typeof c)Da=c;else if("UNDEF-OK"===c)I="UNDEF-OK";else if("DEBUG-CONSOLE-TRACE"===c)ya="DEBUG-CONSOLE-TRACE";else if("THROW-EXCEPTIONS"===
c)Y="THROW-EXCEPTIONS";else if("NO-ERROR-MESSAGES"===c)la="NO-ERROR-MESSAGES";else if("LOG-ERRORS"===c)Z="LOG-ERRORS";else if("CONSOLE-COUNT"===c)ja="CONSOLE-COUNT";else if("NO-CHECKING"!==c)if("DEBUG-ERROR-TAGS"===c)xa="DEBUG-ERROR-TAGS";else if(""!==c)throw c=`Not THROW-EXCEPTIONS/LOG-ERRORS/UNDEF-OK/DEBUG-CONSOLE-TRACE/NO-CHECKING, unknown : ${A(c)}`,h(c,"EX@107");});U=!!(Y||Z||la);return[Y,Z,la,I,ya,ja,xa]}function da(a,b,c,d){a=h(a,b);c=qa(c);return y(d,a,c)}function ea(a,b,c,d){if(2!==a.length)var e=
h(`${b}() has 2 argu-ments not ${a.length}`,"ME@401");else{const [m,r]=a;var g=u(m);const w=u(r);e=A(g);a="string"===typeof r?r:A(r);var f="";let C="",G="";"undefined"===typeof r?(C=`${b}() called with 1st param of ${e} and 2nd shape param of undefined`,G="TE@218"):null===r&&(C=`${b}() called with 1st param of ${e} and 2nd shape param of null`,G="TE@220");""!==C&&(f=da(C,G,a,c));e=f;""===e&&(f=p(m),"array"===g&&"array"!==w?(b=1<m.length,"array"!==r&&"a"!==r&&b?(b=a,d=p(m),b=K(b),e=da("Comparing [] parameter, with a"+
` value of ${d}, against expected shape of ${b}. They should be the same type.`+` You cannot compare an array with a non-array; both []s, or both ${b}s`,"TE@219",a,c)):d&&(e=da("There are no parameters.","ME@408",a,c))):"array"===w&&"array"!==g?(d=g,g=a,b=p(m),g=K(g),e=da(`Comparing '${d}' parameter,`+` with a value of ${b}, in relation to expected shape of ${g}. They should be the`+` same type. You cannot compare an array with a non-array; both []s, or both '${d}'s. Or same object keys`,"TE@217",
a,c)):"array"===w?d&&(e=da("There are no params to match array signature.","ME@409",a,c)):"object"===w?"object"!==g&&(e=h(`${b}() called with '{}' against '!{}'.`+` Contrasting a ${g} type of value ${f}, with '${a}' an ${w}`+` !!! ${g} <> ${w}`,"TE@201")):"string"!==w&&(e=h(`${b}() called with 2nd param not a string such as 'number'.`+` Matching '${f}' with '${a}'.`+` Preferably try ${b}(12, 'number')`,"TE@224")))}return e}function Ea(a,b){var c="";if(2!==a.length)c=h(`${b}() needs 2 parameters, not ${a.length}`,
"ME@406");else{a=a[1];const d=A(a);"array"!==u(a)?c=h(`${b}() called with a 2nd parameter`+` as a non-array shape of ${d}`,"ME@402"):2>a.length&&(c=p(a),c=h(`${b}()  needs at least 2 choices for an Either, not ${a.length} of ${c}`,"UE@701"))}return c}function jb(a,b,c){let d=!1;c||Array.isArray(a)||Array.isArray(b)&&1===b.length&&(d=!0);return d}function Fa(a,b){[a]=D(a);return(a=ca(a,b,"EMPTY-EXTRAS"))?y("check_emptyExtra()",a,b):""}function Ga(a,b){[a]=D(a);return(a=V(a,b,"TYPE-EXTRAS"))?y("check_typeExtra()",
a,b):""}function W(a){if(160>a.length)var b=a;else b=a.substring(0,100),a=a.substring(a.length-50),b=`${b} ${"<<<~~~>>>"} ${a}`;return b}function kb(a,b){var c="";if(a!==b){c=0;for(var d=!1;a[c]===b[c];){if(c===a.length||c===b.length){d=!0;break}c+=1}const [g,f]=[c,d];var e=a.length;d=b.length;f?e>d?(c=0===d?"''":b,e=a.substring(g),b="''"):(c=0===e?"''":a,e="''",b=a.substring(g)):(c=0===g?"''":a.substring(0,g),e=0===e?"''":a.substring(g),b=0===d?"''":b.substring(g));a=e;c=W(c);a=W(a);b=W(b);c=p(`${"\n\t\t"}START-SAME ~ ${c}`);
a=p(`${"\n\t\t"}  PRE-DIFF ~ ${a}`);b=p(`${"\n\t\t"} POST-DIFF ~ ${b}`);c=`${c}${a}${b}`}return c}let z,Da=!1,U=!1;const N={},Ta=new WeakSet;let Y=!1,la=!1,Z=!1,I=!1,ja=!1,xa=!1,ya=!1;const ob=/([^(]*\()([^)]*)/,Ra={OK:"EMPTY-OK",ER:"EMPTY-ERROR",IG:"EMPTY-IGNORE"},Ma="Array BigInt Boolean Date Function Number Object RegExp String Symbol".split(" "),Qa={array:"Array",bigint:"BigInt",boolean:"Boolean",date:"Date",function:"Function",number:"Number",object:"Object",regexp:"RegExp",string:"String",symbol:"Symbol"},
Oa="array bigint boolean date function number object regexp string symbol".split(" "),nb=new Set(Oa),wa={a:"array",i:"bigint",b:"boolean",d:"date",f:"function",n:"number",o:"object",r:"regexp",s:"string",y:"symbol"},oa={bBlink:a=>{document.body.style.background=a;setTimeout(()=>{document.body.style.background="white"},100)},onStart:()=>oa.bBlink("green"),onCheck:()=>oa.bBlink("blue"),onError:()=>oa.bBlink("red")},Ca=a=>"array"===a?!0:"object"===a?!0:"string"===a?!0:"regexp"===a?!0:"date"===a?!0:"number"===
a,pa={decycle:function(a,b){var c=new WeakMap;return function f(e,g){void 0!==b&&(e=b(e));if(!("object"!==typeof e||null===e||e instanceof Boolean||e instanceof Date||e instanceof Number||e instanceof RegExp||e instanceof String)){var m=c.get(e);if(void 0!==m)return{$ref:m};c.set(e,g);if(Array.isArray(e)){var r=[];e.forEach(function(w,C){r[C]=f(w,g+"["+C+"]")})}else r={},Object.keys(e).forEach(function(w){r[w]=f(e[w],g+"["+JSON.stringify(w)+"]")});return r}return e}(a,"$")}},Ya=(a,b,c)=>{let d="";
const e=K(b);Array.isArray(a)||(a=[a]);a.forEach((g,f)=>{if(""===d){const m=u(g);if(B(e))d=V(g,e,c);else if(!(e===m||I&&"null"===m||I&&"undefined"===m)){let r=R(e);r||(g=p(g),r=h(`ELEMENT '${f}' is asserted to be a '${e}',`+` but is fallaciously a '${m}' : ${g}`,"TE@215"));d=r}}});return d},Za=(a,b,c)=>{var d="";"null"===a?d=h(` ELEMENT '${b}' type is 'null'`,"TE@204"):"undefined"===a?d=h(` ELEMENT '${b}' type is 'undefined'`,"TE@229"):"string"!==typeof a&&(d=p(a),d=h(` ELEMENT '${b}' type is not a string but instead ${d}`,
"TE@232"));d||(d=R(a))||(d=h(` ELEMENT '${b}' is assumed to be a '${a}',`+` but is mistakenly a '${c}'`,"TE@214"));return d},$a=(a,b,c)=>{let d="";a=K(a[b]);if(va(a)){const e=u(c);a===e||I&&"null"===e||I&&"undefined"===e||("undefined"===typeof c?d=h(`Key '${b}' was given to be a '${a}' but is 'undefined'`,"TE@211"):"null"===e?d=h(`Key '${b}' was determined to be a '${a}' but is 'null'`,"TE@212"):(c=p(c),d=h(`Property '${b}' is indicated to be a '${a}',`+` but is inaccurately a '${e}' : ${c}`,"TE@213")))}else d=
R(a),d||(b=`Type '${A(a)}' is not a real type`,d=h(b,"TE@210"));return d},na=(a,b,c)=>{let d="";const e=u(a);"array"!==e?(a=p(a),d=h(`Variable ${a} must be an array but is instead a '${e}', : ${a}`,"EE@314")):a.forEach((g,f)=>{""===d&&(d=1===b.length?J(g,b,c):J(g,b[f],c))});return d},lb=(a,b,c)=>{let d="";const e=Q(b);Array.isArray(a)||(a=[a]);a.forEach((g,f)=>{if(""===d){const m=S(g);B(e)?d=J(g,e,c):!m||"EMPTY-ERROR"!==e||I&&"null"===m||I&&"undefined"===m||(g=p(g),d=h(`ELEMENT '${f}' is asserted to be a '${e}',`+
...
d=J(a[C],H,c):1!==r&&delete m[C];(w=cb(H,w,C,a,G,c))&&(d=w)}});1!==r&&"EMPTY-EXTRAS"!==c&&a.length!==r&&(d=bb(b,a))}}return d},mb=(a,b,c)=>{let d="";a=Q(a);if("EMPTY-ERROR"===a){const e=u(b),g=Ca(e),f=A(b);g?S(b)&&(d=h(` key '${c}' is a '${e}' which is reputed `+`to be '${a}' but has a value of ${f}`,"EE@301")):d=h(`Type cannot be empty '${c}' ${a} is a ${f} :: ${e}`,"EE@302")}else"EMPTY-OK"!==a&&"EMPTY-IGNORE"!==a&&(b=`Bad empty type key, '${p(a)}', must be either 'EMPTY-OK','EMPTY-ER','EMPTY-IG','OK','ER','IG'`,
d=h(b,"EE@303"));return d},eb=(a,b,c)=>{let d="";const e={...b};B(a)&&Object.entries(a).forEach(g=>{if(""===d){const [m,r]=g;g=A(r);var f=Q(e[m]);B(r)?(f=Q(b[m]),d=S(r)&&"EMPTY-ERROR"===f?h(`Key '${m}' was understood to be '${f}' but was rather '${g}'`,"EE@309"):d+J(a[m],f,c),delete e[m]):Object.prototype.hasOwnProperty.call(e,m)?(d=mb(f,r,m),delete e[m]):"EMPTY-VERIFY"===c&&("string"===u(r)&&(g=`'${g}'`),d=h(`Extra key in checked object - (${m}:${g})`,"EE@315"))}});return d+=za(e)};ib(fa);z=Da?Aa(Da):
Aa(!1);return{_coloredConsole:P,_ParametersCheck:Aa,_anObjectsType:Na,_arrayOfOneShape:lb,_arrayOfOneType:Ya,_aTypeOf:u,_canBeEmpty:Ca,_className:ra,_collectionToStr:Ia,_consoleError:h,_doEitherEmpty:gb,_doEitherShape:hb,_doubleToSingleQuotes:qa,_eitherChecks:Ea,_emptyArrayInArray:na,_emptyArrayTypes:db,_emptyCheck:ca,_emptyCollectionTypes:eb,_emptyContainer:J,_emptyError:cb,_emptyErrorMess:bb,_emptyKeysChecked:mb,_emptyScalar:Ba,_emptyVariable:fb,_errorClassName:Ua,_functionName:La,_getParameters:D,
_isAClass:Ka,_isBuiltInClass:sa,_isCollection:B,_isEmpty:S,_isScalar:function(a){return!B(a)},_isaTypeOf:ta,_isPlainJsType:va,_jsonStr:A,_looksLikeType:R,_missingKey:za,_mutateStacks:function(){return ba(N)},_refDiff:kb,_shapeArrayTypes:Wa,_shapeCollectionTypes:Xa,_shapeContainer:ma,_shapeErrorMess:Va,_shapePropertyType:$a,_shapeScalar:ab,_shapeVariable:V,_shortToLongEmpty:Q,_shortToLongType:K,_shrinkDiffs:W,_specParameters:ib,_stringifyReplacer:Ja,_toStr:p,_twoArrays:ea,_typeFromArray:ha,_wrongType:Za,
_cycle_loops:pa,_fast_json_stable_stringify:ba,TYPE_CZECH_EVENTS:oa,assert_check:function(a,b,c,d){return z.p_call_traps&&a?z.assert_check_(a,b,c,d):""},check_type:function(a,b){if(z.p_call_traps){const [c,d,e]=D(a),g=p(c),f=p(b);let m=ea([c,b],"check_type","check_type()",d);""===m&&(jb(a,b,e)&&(m=["check_type()",`VE@603 - Use check_typeVariadic(${g}, ${f}) instead of check_type()`,b]),""===m&&(m=(a=V(c,b,"TYPE-VERIFY"))?y("check_type()",a,b):""));return m}},check_typeEither:function(a,b){if(z.p_call_traps){[a]=
D(a);let c=Ea([a,b],"check_typeEither");""===c&&(c=(a=hb([a,b],"TYPE-VERIFY"))?y("check_typeEither()",a,b):"");return c}},check_typeExtra:function(a,b){if(z.p_call_traps){const d=B(a),e=B(b);var c=p(b);const [g]=D(a),f=p(g);Array.isArray(b)&&1===b.length?(a=p(b[0]),c=`check_typeExtra(${f}, ${c}) ${`try check_type([${a}, ${a}], ${c})`} as ${c} is illegal.`,c=h(c,"TE@234"),b=y("check_typeExtra()",c,b)):d&&e?"string"===L(b)?b=Ga(a[0],b):"object"===L(b)?b=Ga(a,b):2>g.length?(c=`check_typeExtra(${f}, ${c}) needs each array to have at least 2 types to work`,
...
h(d,"EX@109");d=`${a}-${b}`;var e=pa.decycle(c);e=ba(e);e={func_name:a,var_name:b,collection_ref:c,pre_collect_str:e};N[d]?N[d].push(e):N[d]=[e];return""}},check_mutatedSnapshot:function(a,b){if(z.p_call_traps){var c=p(a),d=p(b),e=`${c}-${d}`,g="",f=N[e];const m=arguments.length;if(2!==m)throw h(`check_mutatedSnapshot() needs 2 param, not ${m}`,"EX@112");if(f){e=N[e].pop();if("undefined"===typeof e)throw h(`check_mutatedSnapshot() has no matching entry for check_buildSnapshot('${c}', '${d}', a_var)`,
"EX@114");const {collection_ref:r,pre_collect_str:w}=e;c=pa.decycle(r);c=ba(c);w!==c&&(e=p(w),d=p(c),g=`Ref var '${b}' in func '${a}()' changed`,e=W(e),f=W(d),d=`${"\n\t\t"}from ${e}`,e=`${"\n\t\t"}  to ${f} ${"\n\t\t"}`,c=kb(w,c),g=h(`${g}${d}${e}${c}`,"ME@405"),g=y("check_mutatedSnapshot()",g,""))}else throw h(`No record of check_mutatedSnapshot('${c}', '${d}', a_var)`,"EX@113");c=pa.decycle(N);ba(c);return g}},enableChecks:function(){return z.enableChecks_()},disableChecks:function(){return z.disableChecks_()},
