...
function _jsonStr_27000(){
  ...
  test_jsonStr(a=>a+8, 'a=>a+8 ~~~function~~~')                               // pass 5 E function
  test_jsonStr(9, '9')                                             // pass 6 F number
  test_jsonStr({b:10}, `{"b":10}`)                                 // pass 7 G object
  test_jsonStr(/d/, '/d/ ~~~regex~~~')                                     // pass 8 H regex
  ...
  test_jsonStr(/(?:)/, '/(?:)/ ~~~regex~~~')                               // pass 15 O empty regex
...
if (fail_count>0) {
  the_problem = `private-tests/_jsonStr_27000.js - fails = ${fail_count}`;  
