...
function _shapeContainer_17001(){
  ...
  if (typeof fail_all_tests!== 'undefined' && fail_all_tests) {
    check_container =  { f: 'yy' };                     // TEST TEST
  } else {
    check_container =  { r: 11 };             // REAL TEST
  }
...
function _shapeContainer_17002(){
  ...
  if (typeof fail_all_tests!== 'undefined' && fail_all_tests) {
    ...
    check_container =  [ 13, 14, 15 ];               // REAL TEST
  }
...
function _shapeContainer_17004(){
  ...
  if (typeof fail_all_tests!== 'undefined' && fail_all_tests) {
    ...
    check_container = [  [[1, 2], [3, 4]], [[5, false], [7, false]] ];                // REAL TEST
  }
...
function _shapeContainer_17005(){
  ...
  if (typeof fail_all_tests!== 'undefined' && fail_all_tests) {
    ...
    check_container = [  [[1, 2], [3, 4]], [[5, false], ['a', false]] ];                  // REAL TEST
  }
...
function _shapeContainer_17006(){
  ...
  if (typeof fail_all_tests!== 'undefined' && fail_all_tests) {
    ...
    check_container = [  {a:[[1, 2], [3, 4]]}, {b:[[5, false], [7, false]]} ];                  // REAL TEST
  }
...
function _shapeContainer_17008(){
  ...
  if (typeof fail_all_tests!== 'undefined' && fail_all_tests) {
    ...
    check_container = [  {a:[[1, 2],     [3, 4]]},         {b:[[5, 1], [7, false]]} ];                  // REAL TEST
  }
...
function _shapeContainer_17009(){
  ...
  if (typeof fail_all_tests!== 'undefined' && fail_all_tests) {
    ...
    check_container = [  {a:[[1, 2],     [3, 4]]},         {b:[['a', false], [7, false]]} ];                 // REAL TEST
  }
...
function _shapeContainer_17101(){
  ...
  if (typeof fail_all_tests!== 'undefined' && fail_all_tests) {
    ...
    check_container = [  {A:{B:[[1, 2],     [3, 4]]}},         {C:{D:[[8, false], [7, false]]}} ];                    // REAL TEST
  }
...
function _shapeContainer_17102(){
  ...
  if (typeof fail_all_tests!== 'undefined' && fail_all_tests) {
    ...
    check_container = [  {E:{B:[[1, 2],     [3, 4]]}},         {C:{D:[[8, false], [7, false]]}} ];                  // REAL TEST
  }
...
function _shapeContainer_17103(){
  ...
  if (typeof fail_all_tests!== 'undefined' && fail_all_tests) {
    ...
    check_container = [  {A:{E:[[1, 2],     [3, 4]]}},         {C:{D:[[8, false], [7, false]]}} ];                  // REAL TEST
  }
