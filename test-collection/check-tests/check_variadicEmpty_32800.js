...
function test_pre_check_variadicEmpty(actual_variable, variable_signature, error_id, expected_error) {
  ...
  function PRE_test_32800() {
    return type_czech_test.check_variadicEmpty(arguments, variable_signature);
  }

  function pre_check_variadicEmpty_32800() {}
  pre_check_variadicEmpty_32800 = type_czech_test.linkUp(pre_check_variadicEmpty_32800, PRE_test_32800);
