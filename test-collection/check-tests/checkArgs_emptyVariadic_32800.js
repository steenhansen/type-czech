...
A_yourFunc()                         // pass 11 S empty nothing
A_yourFunc([11,12,13])               // pass 12 T multi array
A_yourFunc(14,15,16)                 // pass 13 U multi args
A_yourFunc([[17,18,19]])             // pass 14 V multi in single
A_yourFunc([20], [21])               // pass 15 W two singles
A_yourFunc([22,23,24], [25,26,27])   // pass 16 X two multis
A_yourFunc({d:{}})                   // pass 17 Y empty in object
A_yourFunc([{e:[28,{f:[29]}]}])      // pass 18 Z empty in object
A_yourFunc(['',''] )                 // pass 19 0 empty - [str str]
A_yourFunc([[],[]] )                 // pass 20 1 empty - [arr arr]
A_yourFunc([{},{}] )                 // pass 21 2 empty - [obj obj]
A_yourFunc({g:[]},{h:[]})            // pass 22 3 empty - {arr arr}
A_yourFunc({i:''},{j:''})            // pass 23 4 empty - {str str}
A_yourFunc({k:{}},{l:{}})            // pass 24 5 empty - {obj obj}
TEST_total_checks += expectedAndFailedTests(24, 0, 'A-Pass', 'checkArgs_emptyVariadic().md');
...
TEST_total_checks += expectedAndFailedTests(8, 8, 'A-Fail', 'checkArgs_emptyVariadic().md');
