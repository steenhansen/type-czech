...
function test_pre_check_variadicType(parameters_array, signature_of_parameters, error_id, expected_error) {
  ...
  function PRE_test_32900() {
    return type_czech_test.check_variadicType(arguments, signature_of_parameters);
  }

  function pre_check_variadicType_32900() {}
  pre_check_variadicType_32900 = type_czech_test.linkUp(pre_check_variadicType_32900, PRE_test_32900);
