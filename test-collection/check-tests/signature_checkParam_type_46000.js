...
signature_stringParameters_46501();
signature_stringParameters_46502();
signature_stringParameters_46503();
signature_stringParameters_46504();
signature_stringParameters_46505();


signature_filledStrParams_46601();
signature_filledStrParams_46602();
signature_filledStrParams_46603();

TEST_total_fails += failed_signatures;
TEST_total_checks += tested_signatures;
if (TEST_show_random) {
  console.log('variadic failed tests 32000', failed_signatures)
  console.log('variadic passed tests 32000', tested_signatures)
}
...
function signature_stringParameters_46501(){
  TYPE_CZECH_current_test_number = '46501';
  type_czech=TypeCzech('THROW-EXCEPTIONS', 'DEBUG-ERROR-TAGS');
  stringParameters= () => { }
...
function signature_stringParameters_46502(){
  TYPE_CZECH_current_test_number = '46502';
  type_czech=TypeCzech('THROW-EXCEPTIONS', 'DEBUG-ERROR-TAGS');
  stringParameters= () => { }
  function PRE_check_stringParameters(){
    return type_czech.checkArgs_typeVariadic(arguments, ['string'])
...
function signature_stringParameters_46503(){
  TYPE_CZECH_current_test_number = '46503';
  type_czech=TypeCzech('THROW-EXCEPTIONS', 'DEBUG-ERROR-TAGS');
  stringParameters= () => { }
  function PRE_check_stringParameters(){
    return type_czech.checkArgs_typeVariadic(arguments, ['string'])
...
function signature_stringParameters_46504(){
  TYPE_CZECH_current_test_number = '46504';
  type_czech=TypeCzech('THROW-EXCEPTIONS', 'DEBUG-ERROR-TAGS');
  stringParameters= () => { }
  function PRE_check_stringParameters(){
    return type_czech.checkArgs_typeVariadic(arguments, ['string'])
...
function signature_stringParameters_46505(){
  TYPE_CZECH_current_test_number = '46505';
  type_czech=TypeCzech('THROW-EXCEPTIONS', 'DEBUG-ERROR-TAGS');
  stringParameters= () => { }
  function PRE_check_stringParameters(){
    return type_czech.checkArgs_typeVariadic(arguments, ['string'])
...
function signature_filledStrParams_46601(){
  TYPE_CZECH_current_test_number = '46601';
...
function signature_filledStrParams_46602(){
  TYPE_CZECH_current_test_number = '46602';
  filledStrParams= () => { }
...
function signature_filledStrParams_46603(){
  TYPE_CZECH_current_test_number = '46603';
  filledStrParams= (filled_string) => { }
